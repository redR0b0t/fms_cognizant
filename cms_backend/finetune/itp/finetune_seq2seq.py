...
def main():
    ...
    def prepare_features(examples):
        ...
        for instruction, inpu, response in zip(instructions, inputs, responses):
            if inpu == "":
                prompt = PROMPT_DICT["prompt_no_input"].format(instruction)
            else:
                prompt = PROMPT_DICT["prompt_input"].format(instruction, inpu)
